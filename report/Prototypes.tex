...
\centering
\includegraphics 
	[width = 0.65\textwidth] {Ricardo/ricardo_prototipo_1}
...
Depois de algumas iterações com apresentações, entrevistas e testes de usabilidade que levaram a uma constante modificação do protótipo, criou-se o protótipo final.

Este protótipo é um Demo do jogo que imaginámos construir, permitindo ao jogador ver os mecanismos de jogo e ao mesmo tempo passar a mensagem séria (Figuras \ref{fig:gameplay} e \ref{att:fig:spyw}).

Joga aqui: \url{http://web.tecnico.ulisboa.pt/~ist173890/ccu/game}
