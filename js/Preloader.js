...
Scene.Preloader.prototype = {
    preload: function () {
        ...
        this.load.spritesheet('bullet1', 'assets/images/dynamic/avbullet17x40x4.png', 19, 35);
        this.load.spritesheet('bullet', 'assets/images/dynamic/spybullet30x48x4.png', 30, 48);
