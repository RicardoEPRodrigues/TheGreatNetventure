...
Este protótipo é um Demo do jogo que imaginámos construir, permitindo ao jogador ver os mecanismos de jogo e ao mesmo tempo passar a mensagem séria (Figuras \ref{fig:spyw} e \ref{fig:gameplay}).
