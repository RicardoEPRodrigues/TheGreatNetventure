...
\centering
\includegraphics 
	[width = 0.75\textwidth] {Tiago/tiago_prototipo_3}
\caption{\label{att:fig:tiago:prot3}} Terceiro Protótipo do Tiago
\end{figure}

\begin{figure}[h]
\centering
\includegraphics 
	[width = 0.75\textwidth] {Tiago/tiago_prototipo_4}
\caption{\label{att:fig:tiago:prot4}} Quarto Protótipo do Tiago
\end{figure}
